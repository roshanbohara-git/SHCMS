...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_name', models.CharField(default='First', max_length=255)),
                ...
                ('contact_number', models.CharField(default='0000000000', max_length=20)),
                ('email', models.EmailField(default='doctor1@example.com', max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_number', models.CharField(default='0000000000', max_length=20)),
                ('email', models.EmailField(default='patient@example.com', max_length=254)),
                ('address', models.TextField(default='Unknown')),
                ('blood_group', models.CharField(default=' Unknown', max_length=10)),
                ('emergency_contact', models.CharField(default='0000000000', max_length=20)),
